...
public class SearchActivity extends Activity {
		...
		public boolean onOptionsItemSelected(MenuItem item){
			...
			case R.id.action_log:
				Intent intentLog = new Intent(SearchActivity.this, LoginActivity.class);
			...
			case R.id.action_priv:
				Intent intentPriv = new Intent(SearchActivity.this, PrivilegesActivity.class);
			...
			case R.id.action_subscription:
				Intent intentSubscription = new Intent(SearchActivity.this, SubscriptionActivity.class);
		...
		/**
    		 * Is used if AllDatesButton is clicked.
    		 * Switches to SingleEventListActivity.
    		 * 
    		 * @param view
    		 */
		public void onAllDatesButtonClick(View view){
		    	Intent intentEventPriv = new Intent(SearchActivity.this, SingleEventListActivity.class);
