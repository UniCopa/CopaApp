...
public class SingleEventListActivity extends Activity {
		...
		public boolean onOptionsItemSelected(MenuItem item){
			...
			case R.id.action_log:
				Intent intentLog = new Intent(SingleEventListActivity.this, LoginActivity.class);
				SingleEventListActivity.this.startActivity(intentLog);
				return true;
			case R.id.action_main:
				Intent intentMain = new Intent(SingleEventListActivity.this, MainActivity.class);
				SingleEventListActivity.this.startActivity(intentMain);
				return true;
			case R.id.action_search:
				Intent intentSearch = new Intent(SingleEventListActivity.this, SearchActivity.class);
				SingleEventListActivity.this.startActivity(intentSearch);
				return true;
			case R.id.action_priv:
				Intent intentPriv = new Intent(SingleEventListActivity.this, PrivilegesActivity.class);
				SingleEventListActivity.this.startActivity(intentPriv);
				return true;
			case R.id.action_settings:
				Intent intentSettings = new Intent(SingleEventListActivity.this, SettingsActivity.class);
				SingleEventListActivity.this.startActivity(intentSettings);
				return true;
			case R.id.action_subscription:
				Intent intentSubscription = new Intent(SingleEventListActivity.this, SubscriptionActivity.class);
		...
		/**
    		 * Is used if SingleEventListButton is clicked.
    		 * Switches to SingleEventActivity.
    		 * 
    		 * @param view
    		 */
		public void onSingleEventListButtonClick(View view){
		    Intent intentSingleEvent = new Intent(SingleEventListActivity.this, SingleEventActivity.class);
		...
		public void onChangeDateButtonClick(View view){
		    Intent intentSingleEvent = new Intent(SingleEventListActivity.this, ChangeSingleEventActivity.class);
		    SingleEventListActivity.this.startActivity(intentSingleEvent);
		}
