...
public class SingleEventActivity extends Activity {
		...
		public boolean onOptionsItemSelected(MenuItem item){
			...
			case R.id.action_log:
				Intent intentLog = new Intent(SingleEventActivity.this, LoginActivity.class);
				SingleEventActivity.this.startActivity(intentLog);
				return true;
			case R.id.action_main:
				Intent intentMain = new Intent(SingleEventActivity.this, MainActivity.class);
				SingleEventActivity.this.startActivity(intentMain);
				return true;
			case R.id.action_search:
				Intent intentSearch = new Intent(SingleEventActivity.this, SearchActivity.class);
				SingleEventActivity.this.startActivity(intentSearch);
				return true;
			case R.id.action_priv:
				Intent intentPriv = new Intent(SingleEventActivity.this, PrivilegesActivity.class);
				SingleEventActivity.this.startActivity(intentPriv);
				return true;
			case R.id.action_settings:
				Intent intentSettings = new Intent(SingleEventActivity.this, SettingsActivity.class);
				SingleEventActivity.this.startActivity(intentSettings);
				return true;
			case R.id.action_subscription:
				Intent intentSubscription = new Intent(SingleEventActivity.this, SubscriptionActivity.class);
		...
		public void onChangeDateButtonClick(View view){
		    Intent intentSingleEvent = new Intent(SingleEventActivity.this, ChangeSingleEventActivity.class);
