...
public class SubscriptionActivity extends Activity {
		...
		public boolean onOptionsItemSelected(MenuItem item){
			...
			case R.id.action_log:
				Intent intentLog = new Intent(SubscriptionActivity.this, LoginActivity.class);
				SubscriptionActivity.this.startActivity(intentLog);
				return true;
			case R.id.action_main:
				Intent intentMain = new Intent(SubscriptionActivity.this, MainActivity.class);
				SubscriptionActivity.this.startActivity(intentMain);
				return true;
			case R.id.action_search:
				Intent intentSearch = new Intent(SubscriptionActivity.this, SearchActivity.class);
				SubscriptionActivity.this.startActivity(intentSearch);
				return true;
			case R.id.action_priv:
				Intent intentPriv = new Intent(SubscriptionActivity.this, PrivilegesActivity.class);
		...
		/**
    		 * Is used if AlDatesButton is clicked.
    		 * Switches to SingleEventListActivity.
    		 * 
    		 * @param view
    		 */
		public void onAllDatesButtonClick(View view){
		    	Intent intentSingleEventList = new Intent(SubscriptionActivity.this, SingleEventListActivity.class);
